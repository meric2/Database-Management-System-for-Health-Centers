...
public class CreateDoctor extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String  docfname = request.getParameter("docfname");
			String  doclname = request.getParameter("doclname");
			String  centerid = request.getParameter("centerid");
			String  sex = request.getParameter("sex");
			String sql = "insert into HEALTHCENTER_SYSTEM.Doctor(docssn,docfname,doclname,centerid,sex) values(?,?,?,?,?)";
